...
class SimConfig:
    ...
    # --- real market sentiment override ---
    # Pre-computed daily sentiment sequence from real token price data.
    # When set, the simulated sentiment update is bypassed each day and
    # the value from this sequence is used directly.  Length must be >= episode_days.
    # Generated by: chainenv.real_sentiment.build_sentiment_sequence()
    sentiment_override_sequence: list | None = None
